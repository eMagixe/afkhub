import { shallowRef, computed, ref, toValue, reactive } from 'vue';
...
const useCategory = () => {
  ...
  const loadCategory = async () => {
    const { data } = await useFetch("/api/categories", "$Uc2QcW0R6b");
    if (data) {
...
export { useCategory as a, useLoadingIndicator as u };
//# sourceMappingURL=loading-indicator-VUhMIUcD.mjs.map
