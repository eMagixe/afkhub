import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, createElementBlock, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, mergeProps, getCurrentScope, useSSRContext } from 'vue';
import { k as klona, i as defuFn, e as createError$1, j as hasProtocol, l as isScriptProtocol, m as joinURL, w as withQuery, s as sanitizeStatusCode, n as getContext, $ as $fetch$1, o as baseURL, q as createHooks, r as isEqual, t as stringifyParsedURL, v as stringifyQuery, x as parseQuery, y as toRouteMatcher, z as createRouter, A as defu } from '../nitro/nitro.mjs';
...
const LazyIcon = defineAsyncComponent(() => import('./index-CV4NCVbG.mjs').then((r) => r["default"] || r.default || r));
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-1e4a8e77"]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-ao7JeOsT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BjZHypaf.mjs'));
