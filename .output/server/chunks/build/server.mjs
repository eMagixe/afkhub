import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, ref, mergeProps, getCurrentScope, useSSRContext } from 'vue';
...
const LazyIcon = defineAsyncComponent(() => import('./index-C-g6N5if.mjs').then((r) => r["default"] || r.default || r));
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}> AFK Hub </div>`);
}
